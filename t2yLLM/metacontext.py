...
class PokeAPIFunctions:
    ...
    def _transform_pokeapi_to_tyradex_format(pokemon_data, species_data):
        ...
        transformed = {
            ...
            "talents": abilities,
            "stats": stats,
            "height": f"{pokemon_data.get('height', 0) / 10} m",  # PokeAPI gives decimeters
            "weight": f"{pokemon_data.get('weight', 0) / 10} kg",  # PokeAPI gives hectograms
        ...
        try:
            ...
            if abilities:
                ...
                if regular_abilities:
                    ...
                    if hidden_abilities:
                        description += f", and it has the hidden ability: {', '.join(hidden_abilities)}"
                    description += "."
                elif hidden_abilities:
                    description += f" It only has the hidden ability: {', '.join(hidden_abilities)}."
            ...
            if stats:
                ...
                description += f"{stats.get('spe_atk', 0)} Special Attack, {stats.get('spe_def', 0)} Special Defense, "
            ...
            if male_rate > 0 and female_rate > 0:
                description += f" The gender distribution is {male_rate}% male and {female_rate}% female."
            elif male_rate == 0 and female_rate == 0:
